...
class Kalk < Formula
  ...
  on_macos do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/releases/download/0.5.0/kalk.0.5.0.osx-x64.tar.gz"
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/releases/download/0.5.0/kalk.0.5.0.osx-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/releases/download/0.5.0/kalk.0.5.0.linux-x64.tar.gz"
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_32_bit?
      url "https://github.com/releases/download/0.5.0/kalk.0.5.0.linux-arm.tar.gz"
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/releases/download/0.5.0/kalk.0.5.0.linux-arm64.tar.gz"
